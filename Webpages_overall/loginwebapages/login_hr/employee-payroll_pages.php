...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $connection = new mysqli($servername, $username, $password, $database);
	  ...
	  $sql="SELECT register_id,employee_number,first_name,middle_name,surname,suffix,civil_status,department,designation,employee_status,qual_dept_status FROM newemployee_register WHERE register_id = $id";
...
<body>
  ...
  <div class="container">
    <header>Employee Payroll</header>
        ...
        <div class="fields">
          ...
          <div class="fields">  
            ...
            <div class="input-field">
              ...
              <input type="text" name="employee_status" id="employee_status" disabled="">
            </div>
          </div>
