...
<body>
	<div class="menu-bar">
    <ul>
      <li class="active"><i class='bx bx-home-smile'></i><a href="/Webpages_overall/loginwebapages/login_cashier2/cashier2page.php">Home</a></li>
      ...
      <li><i class='bx bx-calculator'></i><a href="#">POS-B</a>
        <div class="sub-menu-4">
          <ul>
            <li><a href="/Webpages_overall/loginwebapages/login_cashier2/POS-B_pages.php" >Cashier 2</a></li>
            <li><a href="#" disabled>Sales of POS-B</a></li>
          </ul>
        </div>
      </li>
  ...
  <div class="container">
			<center><h1>Welcome, Cashier2!</h1></center>
