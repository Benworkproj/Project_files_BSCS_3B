            ...
            <form action="" class="bg-very-light-gray" method="POST">
                ...
                <div class="accordion-body">
                    ...
                    <div class="row fst-italic g-3 position-relative">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control " id="Number-of-Dependent(s)"
                                placeholder=" Number of Dependent(s) ">
                        ...
                        <div class="col-sm-2 text-sm-center img-thumbnail position-absolute top-0 end-0">
                            ...
                            <input type="image" src="../public/assets/img/default_profile_image.jpg" alt="default_profile_image"
                    ...
                    <div class="row row-cols-2 accordion-body g-5">
                        ...
                        <div class="col">
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="BasicPay1" name="BPratehr" value="<?php if(isset($_POST['net'])){echo $_POST['BPratehr'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="BasicPay2" name="BPcutoff" value="<?php if(isset($_POST['net'])){echo $_POST['BPcutoff'];} ?>">
                                </div>
                            </div>
                    ...
                    <div class="row row-cols-2 accordion-body g-5">
                        ...
                        <div class="col">
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="Honorarium1" name="HIratehr" value="<?php if(isset($_POST['net'])){echo $_POST['HIratehr'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="Honorarium2" name="HIcutoff" value="<?php if(isset($_POST['net'])){echo $_POST['HIcutoff'];} ?>">
                                </div>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherDeduction1" placeholder="0.00" name="OTsss" value="<?php if(isset($_POST['net'])){echo $_POST['OTsss'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherDeduction2" placeholder="0.00" name="OTpag" value="<?php if(isset($_POST['net'])){echo $_POST['OTpag'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherDeduction3" placeholder="0.00" name="OTfacdep" value="<?php if(isset($_POST['net'])){echo $_POST['OTfacdep'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherDeduction4" placeholder="0.00" name="OTfacloan" value="<?php if(isset($_POST['net'])){echo $_POST['OTfacloan'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherDeduction5" placeholder="0.00" name="OTsalary" value="<?php if(isset($_POST['net'])){echo $_POST['OTsalary'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherDeduction6" placeholder="0.00" name="OTother" value="<?php if(isset($_POST['net'])){echo $_POST['OTother'];} ?>">
                                </div>
                    ...
                    <div class="row row-cols-2 accordion-body g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherIncome1" name="OTratehr" value="<?php if(isset($_POST['net'])){echo $_POST['OTratehr'];} ?>">
                                </div>
                            </div>
                            ...
                            <div class="row md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="OtherIncome2" name="OTcutoff" value="<?php if(isset($_POST['net'])){echo $_POST['OTcutoff'];} ?>">
                                </div>
                            </div>
